...
- Successfully built an Object Measurement Web application using OpenCV in Python, Dash Python Plotly, & Supervisor (A Process Control System) 
  ...
  - Integrated the Object Measurement Web Application into Ruby on Rails application via iframe
  - Set up AWS EC2 to host the Object Measurement Web application
- Built prototypes connecting an AI object detection model to the web
...
- Learned Ruby on Rails and contributed to the development
- Trained junior developers on front-end
- Worked on front-end framework, AngularJS 
- Created prototypes based on designs from the UI/UX designer
